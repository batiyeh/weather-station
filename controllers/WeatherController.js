...
router.post('/temp', async function (req, res) {
    ...
    var fromDate = req.body.fromDate.format("YYYY-MM-DD");
    var toDate = req.body.toDate.format("YYYY-MM-DD");
    var dayBeginTime =  toDate+' 00:00:00';
    var dayEndTime =  fromDate+' 23:59:59';
    try{
